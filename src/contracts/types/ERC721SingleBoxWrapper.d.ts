...
interface ERC721SingleBoxWrapperInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721SingleBoxWrapper extends BaseContract {
  ...
  interface: ERC721SingleBoxWrapperInterface;
