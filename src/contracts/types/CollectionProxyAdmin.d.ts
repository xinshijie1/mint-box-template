...
interface CollectionProxyAdminInterface extends ethers.utils.Interface {
  functions: {
...
export class CollectionProxyAdmin extends BaseContract {
  ...
  interface: CollectionProxyAdminInterface;
